...
@property (nonatomic, weak) IBOutlet UIProgressView * __null_unspecified rightTimerProgress;
@property (nonatomic, weak) IBOutlet UIProgressView * __null_unspecified leftTimerProgress;
